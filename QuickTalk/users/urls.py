...
from .views import CustomUserLoginAPIView, CustomUserCreateAPIView, CustomUserLogoutAPIView, CustomUserUpdateAPIView, CustomUserSearchAPIView, CustomUserDetailAPIView
...
urlpatterns = [
    ...
    path('detail-user/<int:pk>/', CustomUserDetailAPIView.as_view(), name='api-detail-user'),
]
